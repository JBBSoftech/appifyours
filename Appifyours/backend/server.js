...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/appifyours_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '6953d9816236cb45fe656e1d',
      shopName: 'appifyours',
...
app.listen(PORT, () => {
  console.log(`appifyours Backend Server running on port ${PORT}`);
});
